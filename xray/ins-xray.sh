...
#wget -q -O /usr/bin/bbr "https://raw.githubusercontent.com/taoomatoa/src/ipuk/ssh/bbr.sh"
#chmod +x /usr/bin/bbr
#bbr >/dev/null 2>&1
...
sleep 1
wget -q -O /usr/bin/add-ws "https://raw.githubusercontent.com/taoomatoa/src/ipuk/xray/add-ws.sh" && chmod +x /usr/bin/add-ws
wget -q -O /usr/bin/add-vless "https://raw.githubusercontent.com/taoomatoa/src/ipuk/xray/add-vless.sh" && chmod +x /usr/bin/add-vless
wget -q -O /usr/bin/add-tr "https://raw.githubusercontent.com/taoomatoa/src/ipuk/xray/add-tr.sh" && chmod +x /usr/bin/add-tr
wget -q -O /usr/bin/del-user "https://raw.githubusercontent.com/taoomatoa/src/ipuk/xray/del-ws.sh" && chmod +x /usr/bin/del-user
