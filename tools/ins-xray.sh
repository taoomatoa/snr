...
wget -q -O /etc/nginx/nginx.conf "https://franata775.xcodehoster.com/v1.5/tools/nginx.conf" 
#mkdir -p /home/vps/public_html
wget -q -O /etc/nginx/conf.d/vps.conf "https://franata775.xcodehoster.com/v1.5/tools/vps.conf"
