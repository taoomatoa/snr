...
wget -q -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/taoomatoa/src/ipuk/bckp/rclone.conf"
...
wget -q -O /usr/bin/backup "https://raw.githubusercontent.com/taoomatoa/src/ipuk/bckp/backup.sh" && chmod +x /usr/bin/backup
wget -q -O /usr/bin/restore "https://raw.githubusercontent.com/taoomatoa/src/ipuk/bckp/restore.sh" && chmod +x /usr/bin/restore
wget -q -O /usr/bin/cleaner "https://raw.githubusercontent.com/taoomatoa/src/ipuk/bckp/logcleaner.sh" && chmod +x /usr/bin/cleaner
