...
echo -e "   ${YELLOW}FAIL2BAN${NC}   :    ${GREEN}ON$NS   ${YELLOW}WEBSOCKET${NC}   :   ${GREEN}ON    ${YELLOW}NGINX${NC}      :  ${status_nginx}"
echo -e " ╰════════════════════╯╰═══════════════════╯╰══════════════════╯${NC}"
echo -e ""
echo -e "                          ⇱ MENU SERVER ⇲"
echo -e " ╭═════════════════════════════════════════════════════════════╮$NC"
...
echo -e " │     [${YELLOW}04${NC}]${NC} ADD SHADOWSHOCK$NC      │$NC     [${YELLOW}11${NC}]${NC} CHANGE BANNER$NC"                                                                                                   echo -e " │     [${YELLOW}05${NC}]${NC} TRIAL MENU$NC           │$NC     [${YELLOW}12${NC}]${NC} PORT INFORMATION$NC"
echo -e " │     [${YELLOW}06${NC}]${NC} RUN SERVICE$NC          │$NC     [${YELLOW}13${NC}]${NC} CHANGE PASSWD VPS$NC"                                                                                               echo -e " │     [${YELLOW}07${NC}]${NC} CERTIFICATE SS$NC       │$NC     [${YELLOW}14${NC}]${NC} REBOOT VPS$NC"
echo -e " │"                                                                                                                                                                                                         echo -e " │     [${RED}00${NC}]${NC} EXIT MENU$NC"                                                                                                                                                                   echo -e " ╰═════════════════════════════════════════════════════════════╯$NC"                                                                                                                                        echo -e "   ${CYAN}╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"                                                                                                                          echo -e "   │ $NC Version${NC}        : $NC V1.0"                                                                                                                                                                    echo -e "   │ $NC Developer${NC}      : $NC TaooMatoa"                                                                                                                                                               echo -e "   │ $NC User${NC}           : ${YELLOW} $Name"                                                                                                                                                             echo -e "   │ $NC Expire Script${NC}  : ${YELLOW} $Exp"
echo -e "   ${CYAN}╰═════════════════════════════════════════════════════════╯\033[0m${NC}"
echo -e ""                                                                                                echo -e "                          ⇱ MENU SERVER ⇲"
echo -e ""
